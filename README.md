...
This repository contains the frozen architecture baseline, the complete SCL Phase 1 core networking foundation, the complete Phase 2 Android video pipeline through RFC-002G, the complete Phase 3 audio pipeline through RFC-003H, and the Phase 4 reverse-input foundation through RFC-004B.
...
- Reverse UDP input transport, privileged target-side input injection, target/input mapping, or end-to-end reverse input.
