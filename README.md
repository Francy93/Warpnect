...
This repository contains the frozen architecture baseline, the complete SCL Phase 1 core networking foundation, the complete Phase 2 Android video pipeline through RFC-002G, and Phase 3 audio foundations through RFC-003D.
...
- Remote Android PCM playback, end-to-end audio receive/playback orchestration, and A/V synchronization are not implemented yet.
